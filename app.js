// API Key for this project AIzaSyD1xYylx_hIvvEBsuzVhoV-jOhsaOUdjhI
// Transfer using: key=AIzaSyD1xYylx_hIvvEBsuzVhoV-jOhsaOUdjhI
$( document ).ready(function() {
	
	//Variables
	var _searchText; //variable to store the text the user inserted in the text box
	var _apiKey = ":keyes&key=AIzaSyD1xYylx_hIvvEBsuzVhoV-jOhsaOUdjhI"; //variable containing the last parameter of the GET request and the API key
